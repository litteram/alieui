...
function L:StartFadeIn(frame)
    ...
    frame.fader.finAlpha = frame.faderConfig.fadeInAlpha or 1
...
function L:StartFadeOut(frame)
    ...
    frame.fader.finAlpha = frame.faderConfig.fadeOutAlpha or 0
...
local function IsMouseOverFrame(frame)
    if frame.faderConfig.IsMouseover then
        return frame.faderConfig.IsMouseover(frame)
    end
