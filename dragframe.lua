...
function aLib:CreateDragFrame(frame, frames, inset, clamp)
...
function aLib:CreateDragResizeFrame(frame, frames, inset, clamp)
  if not frame or not frames then return end
  aLib:CreateDragFrame(frame, frames, inset, clamp)
