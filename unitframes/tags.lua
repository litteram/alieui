...
oUF.Tags.Methods['aLie:name'] = function(u)
	return StatusColor(u)..oUF.Tags.Methods['name'](u).."|r"
end
oUF.Tags.Events['aLie:name'] = 'UNIT_CONNECTION UNIT_NAME_UPDATE UNIT_THREAT_SITUATION_UPDATE'


oUF.Tags.Methods['aLie:shortname'] = function(u)
...
oUF.Tags.Events['aLie:shortname'] = 'UNIT_NAME_UPDATE UNIT_HEALTH UNIT_CONNECTION UNIT_THREAT_SITUATION_UPDATE'


oUF.Tags.Methods['aLie:level'] = function(u)
...
oUF.Tags.Events['aLie:level'] = 'UNIT_LEVEL UNIT_CONNECTION'

oUF.Tags.Methods["aLie:health"] = function(unit)
...
oUF.Tags.Events["aLie:health"] = "UNIT_HEALTH UNIT_CONNECTION"

oUF.Tags.Methods['aLie:power'] = function(u)
	return oUF.Tags.Methods['powercolor'](u)..sValue(UnitPower(u))
end
oUF.Tags.Events['aLie:power'] = 'UNIT_POWER_UPDATE PLAYER_SPECIALIZATION_CHANGED PLAYER_TALENT_UPDATE UNIT_CONNECTION'


oUF.Tags.Methods['aLie:altpower'] = function(u)
	local cur = UnitPower(u, ALTERNATE_POWER_INDEX)
	local max = UnitPowerMax(u, ALTERNATE_POWER_INDEX)
	if max == 0 then return end
	return ('|cffCDC5C2'..sValue(cur))..('|cffCDC5C2 / ')..sValue(max)
end
oUF.Tags.Events['aLie:altpower'] = 'UNIT_POWER_UPDATE UNIT_MAXPOWER'
